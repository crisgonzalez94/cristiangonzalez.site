...
<div class="container-fluid">
    ...
    <hr>
    <p>
        All the programs on this list are free and open, 
        their repositories are available to anyone in the 
        git hub and you have the right to duplicate and 
        modify them, without any obligation to give credit.
    </p>
...
<script>
    let software_link = document.getElementById('software-link');
